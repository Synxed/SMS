    ...
    public partial class EmployeeRegistration : Form
    {
        ...
        private void RegisterButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    connection.Open();
                    var command = "INSERT INTO Employees (EmployeeID, FullName, Sex, Age, Salary, Mobile, PHP, CSharp, CPP, Python, Java, Swift)" +
                                  "Values (@EmployeeID, @Name, @Sex, @Age, @Salary, @Mobile, @PHP, @CSharp, @CPP, @Python, @Java, @Swift)";
                    ...
                    using (var addQueryCommand = new OleDbCommand(command, connection))
                    {
                        ...
                        addQueryCommand.Parameters.AddWithValue("@Age", int.Parse(AgeTextBox.Text));
                ...
                MessageBox.Show("The employee has been successfully registered.", "Registration Successful",
